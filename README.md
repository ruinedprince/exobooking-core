...
2. Desenvolva o plugin seguindo os requisitos em [`docs/challenge/Exo_Booking_Core.md`](docs/challenge/Exo_Booking_Core.md)
3. Use o CLI Jira para criar issues: `python scripts/jira_cli.py create -p EBC ...` (veja [`docs/JIRA.md`](docs/JIRA.md))
